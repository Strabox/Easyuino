...
void loop() {
	...
	*/
	...
	- The color of the led will be the overlap of the amount of 3 colors. See: https://en.wikipedia.org/wiki/Additive_color
	- You can use this link to pick up RGB colors: https://www.w3schools.com/colors/colors_picker.asp
	*/
